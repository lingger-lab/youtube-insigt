...
- 제한: 공개 영상만(비공개·일부공개 불가). 무료 티어 **하루 8시간분**, 요청당 최대 10편. 프리뷰라 "요금·제한은 바뀔 수 있음".
  **2026-09-14 재조사**: 무료 티어 일일 요청 수는 Google이 문서에서 지워 비공식 실측만 있고, 3.8 Flash **≈20/일**, 3.5 Flash-Lite ≈500/일.
  편당 1요청이면 8시간보다 이게 먼저 걸린다. "무료"가 영상 토큰까지인지도 공개 문서로 확정 불가 → 보수적으로 과금 가정.
...
- agentic 모드: ~~긴 영상에 유리~~ **실측(2026-09-14) 채택 안 함** — Flash-Lite agentic이 영상을 읽지 않고 날조(영상 토큰 0), 3.8 Flash agentic은 110초. static이 15분 영상을 9.6초·85K 토큰으로 정확히 처리(FINDINGS F41·F42).
